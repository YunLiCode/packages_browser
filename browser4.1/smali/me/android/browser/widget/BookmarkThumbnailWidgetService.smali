.class public Lme/android/browser/widget/BookmarkThumbnailWidgetService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lme/android/browser/widget/BookmarkThumbnailWidgetService$BookmarkFactory;,
        Lme/android/browser/widget/BookmarkThumbnailWidgetService$StateFilter;
    }
.end annotation


# static fields
.field static final ACTION_CHANGE_FOLDER:Ljava/lang/String; = "me.android.browser.widget.CHANGE_FOLDER"
...
.method static constructor <clinit>()V
    ...
    .line 58
    sput-object v0, Lme/android/browser/widget/BookmarkThumbnailWidgetService;->PROJECTION:[Ljava/lang/String;
...
.method static synthetic access$0()[Ljava/lang/String;
    ...
    .prologue
    .line 58
    sget-object v0, Lme/android/browser/widget/BookmarkThumbnailWidgetService;->PROJECTION:[Ljava/lang/String;
...
.method static changeFolder(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 105
    invoke-static {p0, v3}, Lme/android/browser/widget/BookmarkThumbnailWidgetService;->getWidgetState(Landroid/content/Context;I)Landroid/content/SharedPreferences;
...
.method static removeOrphanedStates(Landroid/content/Context;[I)V
    ...
    .line 125
    .local v1, "prefsDirectory":Ljava/io/File;
    new-instance v3, Lme/android/browser/widget/BookmarkThumbnailWidgetService$StateFilter;

    invoke-direct {v3, p1}, Lme/android/browser/widget/BookmarkThumbnailWidgetService$StateFilter;-><init>([I)V
    ...
    .line 126
    .local v2, "widgetStates":[Ljava/io/File;
    if-eqz v2, :cond_0
    ...
    const-string v5, "BookmarkThumbnailWidgetService"

    new-instance v6, Ljava/lang/StringBuilder;

    const-string v7, "Found orphaned state: "
...
.method static setupWidgetState(Landroid/content/Context;IJ)V
    ...
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "widgetId"    # I
    .param p2, "rootFolder"    # J

    .prologue
    .line 113
    invoke-static {p0, p1}, Lme/android/browser/widget/BookmarkThumbnailWidgetService;->getWidgetState(Landroid/content/Context;I)Landroid/content/SharedPreferences;
...
.method public onGetViewFactory(Landroid/content/Intent;)Landroid/widget/RemoteViewsService$RemoteViewsFactory;
    ...
    :cond_0
    new-instance v1, Lme/android/browser/widget/BookmarkThumbnailWidgetService$BookmarkFactory;

    invoke-virtual {p0}, Lme/android/browser/widget/BookmarkThumbnailWidgetService;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2, v0}, Lme/android/browser/widget/BookmarkThumbnailWidgetService$BookmarkFactory;-><init>(Landroid/content/Context;I)V
