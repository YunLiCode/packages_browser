.class public Lme/android/browser/WallpaperHandler;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lme/android/browser/WallpaperHandler;->mCanceled:Z

    .line 55
    iput-object p1, p0, Lme/android/browser/WallpaperHandler;->mContext:Landroid/content/Context;

    .line 56
    iput-object p2, p0, Lme/android/browser/WallpaperHandler;->mUrl:Ljava/lang/String;
...
.method private openStream()Ljava/io/InputStream;
    ...
    iget-object v3, p0, Lme/android/browser/WallpaperHandler;->mUrl:Ljava/lang/String;

    invoke-static {v3}, Lme/android/browser/DataUri;->isDataUri(Ljava/lang/String;)Z
    ...
    .line 185
    new-instance v0, Lme/android/browser/DataUri;

    iget-object v3, p0, Lme/android/browser/WallpaperHandler;->mUrl:Ljava/lang/String;

    invoke-direct {v0, v3}, Lme/android/browser/DataUri;-><init>(Ljava/lang/String;)V

    .line 186
    .local v0, "dataUri":Lme/android/browser/DataUri;
    new-instance v1, Ljava/io/ByteArrayInputStream;

    .end local v1    # "inputStream":Ljava/io/InputStream;
    invoke-virtual {v0}, Lme/android/browser/DataUri;->getData()[B
    ...
    .line 191
    .end local v0    # "dataUri":Lme/android/browser/DataUri;
...
.method public onMenuItemClick(Landroid/view/MenuItem;)Z
    ...
    .line 66
    iget-object v0, p0, Lme/android/browser/WallpaperHandler;->mUrl:Ljava/lang/String;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lme/android/browser/WallpaperHandler;->getState()Ljava/lang/Thread$State;
    ...
    iget-object v1, p0, Lme/android/browser/WallpaperHandler;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Landroid/app/ProgressDialog;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lme/android/browser/WallpaperHandler;->mWallpaperProgress:Landroid/app/ProgressDialog;

    .line 72
    iget-object v0, p0, Lme/android/browser/WallpaperHandler;->mWallpaperProgress:Landroid/app/ProgressDialog;
    ...
    .line 78
    invoke-virtual {p0}, Lme/android/browser/WallpaperHandler;->start()V
...
.method public run()V
    ...
    iget-object v0, v0, Lme/android/browser/WallpaperHandler;->mContext:Landroid/content/Context;
    ...
    :try_start_0
    invoke-direct/range {p0 .. p0}, Lme/android/browser/WallpaperHandler;->openStream()Ljava/io/InputStream;
    ...
    const-wide/high16 v21, 0x3ff4000000000000L
    ...
    iget-boolean v0, v0, Lme/android/browser/WallpaperHandler;->mCanceled:Z
    ...
    iput-boolean v0, v1, Lme/android/browser/WallpaperHandler;->mCanceled:Z
    ...
    iget-object v0, v0, Lme/android/browser/WallpaperHandler;->mWallpaperProgress:Landroid/app/ProgressDialog;
