.class public Lme/android/browser/BrowserPreferencesPage;
...
.method public onBuildHeaders(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1, p1}, Lme/android/browser/BrowserPreferencesPage;->loadHeadersFromResource(ILjava/util/List;)V
    ...
    invoke-virtual {v1}, Lme/android/browser/BrowserSettings;->isDebugEnabled()Z
    ...
    invoke-virtual {p0, v1}, Lme/android/browser/BrowserPreferencesPage;->getText(I)Ljava/lang/CharSequence;
    ...
    .line 56
    const-class v1, Lme/android/browser/preferences/DebugPreferencesFragment;
    ...
    :cond_0
    iput-object p1, p0, Lme/android/browser/BrowserPreferencesPage;->mHeaders:Ljava/util/List;
...
.method public onBuildStartFragmentIntent(Ljava/lang/String;Landroid/os/Bundle;II)Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lme/android/browser/BrowserPreferencesPage;->getIntent()Landroid/content/Intent;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 39
    invoke-virtual {p0}, Lme/android/browser/BrowserPreferencesPage;->getActionBar()Landroid/app/ActionBar;
...
.method public onGetInitialHeader()Landroid/preference/PreferenceActivity$Header;
    ...
    .line 66
    const-class v3, Lme/android/browser/preferences/BandwidthPreferencesFragment;
    ...
    iget-object v3, p0, Lme/android/browser/BrowserPreferencesPage;->mHeaders:Ljava/util/List;
    ...
    .line 67
    .restart local v1    # "fragName":Ljava/lang/String;
    :cond_2
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 80
    :pswitch_0
    invoke-virtual {p0}, Lme/android/browser/BrowserPreferencesPage;->getFragmentManager()Landroid/app/FragmentManager;
    ...
    .line 83
    :cond_0
    invoke-virtual {p0}, Lme/android/browser/BrowserPreferencesPage;->finish()V
