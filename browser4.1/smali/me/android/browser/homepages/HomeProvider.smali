.class public Lme/android/browser/homepages/HomeProvider;
.super Landroid/content/ContentProvider;
.source "HomeProvider.java"


# static fields
.field public static final AUTHORITY:Ljava/lang/String; = "me.android.browser.home"

.field public static final MOST_VISITED:Ljava/lang/String; = "content://me.android.browser.home/"
...
.method public static shouldInterceptRequest(Landroid/content/Context;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    ...
    invoke-virtual {v5}, Lme/android/browser/BrowserSettings;->useMostVisitedHomepage()Z
    ...
    const-string v5, "me.android.browser.home"
    ...
    invoke-virtual {v5}, Lme/android/browser/BrowserSettings;->isDebugEnabled()Z
    ...
    invoke-static {p1}, Lme/android/browser/homepages/HomeProvider;->interceptFile(Ljava/lang/String;)Z
    ...
    new-instance v5, Lme/android/browser/homepages/RequestHandler;

    invoke-static {p1}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v6

    invoke-direct {v5, p0, v6, v2}, Lme/android/browser/homepages/RequestHandler;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/io/OutputStream;)V

    invoke-virtual {v5}, Lme/android/browser/homepages/RequestHandler;->start()V
...
.method public openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    new-instance v2, Lme/android/browser/homepages/RequestHandler;

    invoke-virtual {p0}, Lme/android/browser/homepages/HomeProvider;->getContext()Landroid/content/Context;
    ...
    invoke-direct {v2, v3, p1, v4}, Lme/android/browser/homepages/RequestHandler;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/io/OutputStream;)V

    invoke-virtual {v2}, Lme/android/browser/homepages/RequestHandler;->start()V
