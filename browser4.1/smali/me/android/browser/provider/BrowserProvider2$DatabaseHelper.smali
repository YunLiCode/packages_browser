.class final Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;
...
# instance fields
.field final synthetic this$0:Lme/android/browser/provider/BrowserProvider2;


# direct methods
.method public constructor <init>(Lme/android/browser/provider/BrowserProvider2;Landroid/content/Context;)V
    .locals 3
    .param p2, "context"    # Landroid/content/Context;

    .prologue
    .line 395
    iput-object p1, p0, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->this$0:Lme/android/browser/provider/BrowserProvider2;
    ...
    invoke-virtual {p0, v0}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->setWriteAheadLoggingEnabled(Z)V
...
.method private addDefaultBookmarks(Landroid/database/sqlite/SQLiteDatabase;J)V
    ...
    iget-object v14, v0, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->this$0:Lme/android/browser/provider/BrowserProvider2;

    invoke-virtual {v14}, Lme/android/browser/provider/BrowserProvider2;->getContext()Landroid/content/Context;
    ...
    invoke-direct {v0, v14, v15}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->replaceSystemPropertyInString(Landroid/content/Context;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v10, v13}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->readRaw(Landroid/content/res/Resources;I)[B
    :try_end_2
    ...
    invoke-direct {v0, v10, v4}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->readRaw(Landroid/content/res/Resources;I)[B
    :try_end_3
...
.method private createDefaultBookmarks(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 653
    invoke-direct {p0, p1, v4, v5}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->addDefaultBookmarks(Landroid/database/sqlite/SQLiteDatabase;J)V
...
.method private replaceSystemPropertyInString(Landroid/content/Context;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v8}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->getClientId(Landroid/content/ContentResolver;)Ljava/lang/String;
...
.method enableSync(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 485
    iget-object v4, p0, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->this$0:Lme/android/browser/provider/BrowserProvider2;

    # invokes: Lme/android/browser/provider/BrowserProvider2;->insertSettingsInTransaction(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)J
    invoke-static {v4, p1, v3}, Lme/android/browser/provider/BrowserProvider2;->access$0(Lme/android/browser/provider/BrowserProvider2;Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)J

    .line 487
    iget-object v4, p0, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->this$0:Lme/android/browser/provider/BrowserProvider2;

    invoke-virtual {v4}, Lme/android/browser/provider/BrowserProvider2;->getContext()Landroid/content/Context;
    ...
    const-string v6, "me.android.browser"
    ...
    .line 502
    invoke-static {v0, v6, v7}, Landroid/content/ContentResolver;->setSyncAutomatically(Landroid/accounts/Account;Ljava/lang/String;Z)V
...
.method importFromBrowserProvider(Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    iget-object v3, v0, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->this$0:Lme/android/browser/provider/BrowserProvider2;

    invoke-virtual {v3}, Lme/android/browser/provider/BrowserProvider2;->getContext()Landroid/content/Context;
    ...
    .line 513
    new-instance v11, Lme/android/browser/provider/BrowserProvider$DatabaseHelper;

    invoke-direct {v11, v10}, Lme/android/browser/provider/BrowserProvider$DatabaseHelper;-><init>(Landroid/content/Context;)V

    .line 514
    .local v11, "helper":Lme/android/browser/provider/BrowserProvider$DatabaseHelper;
    invoke-virtual {v11}, Lme/android/browser/provider/BrowserProvider$DatabaseHelper;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 579
    invoke-virtual {v11}, Lme/android/browser/provider/BrowserProvider$DatabaseHelper;->close()V
    ...
    .end local v11    # "helper":Lme/android/browser/provider/BrowserProvider$DatabaseHelper;
    :goto_2
    return v3

    .line 530
    .restart local v1    # "oldDb":Landroid/database/sqlite/SQLiteDatabase;
    .restart local v2    # "table":Ljava/lang/String;
    .restart local v9    # "c":Landroid/database/Cursor;
    .restart local v11    # "helper":Lme/android/browser/provider/BrowserProvider$DatabaseHelper;
    :cond_6
    const/4 v3, 0x0
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 457
    invoke-virtual {p0, p1}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->createAccountsView(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 458
    invoke-virtual {p0, p1}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->createThumbnails(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 460
    iget-object v0, p0, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->this$0:Lme/android/browser/provider/BrowserProvider2;
    ...
    .line 462
    invoke-virtual {p0, p1}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->importFromBrowserProvider(Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .line 463
    invoke-direct {p0, p1}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->createDefaultBookmarks(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 466
    :cond_0
    invoke-virtual {p0, p1}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->enableSync(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 467
    invoke-virtual {p0, p1}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->createOmniboxSuggestions(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 631
    invoke-virtual {p0, p1}, Lme/android/browser/provider/BrowserProvider2$DatabaseHelper;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
